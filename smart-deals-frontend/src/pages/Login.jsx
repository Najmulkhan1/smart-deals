    ...
    <div className="w-11/12 mx-auto flex items-center justify-center min-h-screen">
      <Suspense>
        <div className="bg-base-100 shadow-lg w-100 rounded p-4 text-black">
          ...
          <form onSubmit={handleLogin} className="text-black p-4 space-y-5">
            <div>
            ...
            <div>
              ...
              />
              <Link to={"/forgot-password"} className="text-gray-600 cursor-pointer text-[12px] hover:text-red-400">Forgot Password?</Link>
            </div>
            <button type="submit" className="btn bg-[linear-gradient(125deg,#632EE3_5.68%,#9F62F2_88.38%)] text-white w-full">
              Login
            </button>
          </form>
          ...
          <div className="p-4">
            {/* Google */}
            <button onClick={handleGoogleLogin} className="btn bg-white text-black w-full shadow border-[#e5e5e5]">
              <svg
